...
# MODEL_NAME = f"fitness-agent-langgraph-14B-qwen2.5-003-d5110cc3-2d3f-4617-a3df-c04324a56440"
        ...
        try:
            ...
            for meal in meals:
                ...
                if not match_key:
                    ...
                    # Provide best-effort diagnostics for why match failed.
                    best_candidate = None
                    best_score = 0.0
                    for cand in tool_names:
                    ...
                    missing_details.append(
                        {
                            ...
                            "best_candidate": tool_recipes.get(best_candidate, {}).get("raw_name", ""),
